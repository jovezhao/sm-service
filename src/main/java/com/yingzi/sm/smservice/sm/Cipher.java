...
public class Cipher {
    ...
    private void Reset() {
        ...
        byte[] p = Utils.byteConvert32Bytes(this.p2.getX().toBigInteger());
        this.sm3keybase.update(p, 0, p.length);
        this.sm3c3.update(p, 0, p.length);
        p = Utils.byteConvert32Bytes(this.p2.getY().toBigInteger());
        this.sm3keybase.update(p, 0, p.length);
        this.ct = 1;
        this.NextKey();
    }
    ...
    public void Dofinal(byte[] c3) {
        byte[] p = Utils.byteConvert32Bytes(this.p2.getY().toBigInteger());
        this.sm3c3.update(p, 0, p.length);
